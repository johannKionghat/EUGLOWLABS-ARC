...
- 🟠 **CLI-029** — `arc setup --apply` auto-bootstrap des prérequis système (Ansible/Python3/Docker/sudo). **Bloque tag stable v0.1.0** + débloque smoke 1f-B. ADR-0011 A3 motivation. ~4h. `tasks/backlog/CLI-029-auto-bootstrap-system-prerequisites.md`
