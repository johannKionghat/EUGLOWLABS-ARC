...
- ✅ CLI-027 — Script `install.sh` curl-friendly + endpoint `install-arc.euglowlabs.com` (2026-05-02)
...
- ✅ E2E-001 — Test bout-en-bout sur VM jetable : `scripts/smoke-test.sh` (~40 checks Bash) + `docs/E2E-test-procedure.md` (9 sections + Annexe A) — Phase 1.5 COMPLETE 11/11 (2026-05-08)

---

## Phase 1.6 — Distribution & packaging
...
- 🟡 **CLI-031** — Embed compose templates Eta (`docker-compose.{prod,sandbox,agents}.yml.eta` + `env.eta`) dans le binaire Bun compilé via codegen manifest (pattern DIST-001 1a-2). **Bloque tag stable v0.1.0**. ~2h sur 5 sub-tasks. **En cours — 2026-05-14.**
